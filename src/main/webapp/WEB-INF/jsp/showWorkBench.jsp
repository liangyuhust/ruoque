    ...
    <div class="row">
        <div class="leftmemu col-md-3 col-sm-5">
            <div class="tab-content">
                ...
                <div class="tab-pane sale_monitor">
                    <div class="list-group nav">
                        <a href="#myHousing" class="list-group-item active" data-toggle="tab">房源管理</a>
                        <a href="#mySaleOrder" class="list-group-item" data-toggle="tab">购房订单管理</a>
        ...
        <div class="content col-md-9 col-sm-7">
            <div class="tab-content">
                    ...
                    <div class="tab-content">
                        <div id="myComer" class="tab-pane active">
                            ...
                            <div class="btn-group nav">
                                <button data-target="#myComerTable" type="button"
                                        class="btn btn-item btn-default active" data-toggle="tab">来人信息列表
                                </button>
                                <button data-target="#myComerNew" type="button" class="btn btn-item btn-default"
                                        data-toggle="tab">添加来人信息
                                </button>
                            </div>
                            <div><br/></div>
                            <div class="tab-content">
                                ...
                                <div id="myComerNew" class="tab-pane col-sm-10">
                                    <form id="myComerNewForm" class="form-horizontal" action="#">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputComerName"
                                                       placeholder="姓名">
                                            </div>
                                            <label for="inputComerPhone" class="col-sm-2 control-label">联系方式:</label>

                                            <div class="col-sm-4">
                                                <input type="tel" class="form-control" id="inputComerPhone"
                                                       placeholder="电话">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="date" class="form-control" id="inputComerDate"
                                                       placeholder="来访日期">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputComerType"
                                                       placeholder="来客类型">
                                            </div>
                                            <label for="inputComerCategory" class="col-sm-2 control-label">来客类别:</label>

                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputComerCategory"
                                                       placeholder="来客类别">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputComerTransportMeans"
                                                   class="col-sm-2 control-label">交通工具:</label>

                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputComerTransportMeans"
                                                       placeholder="交通工具">
                                            </div>
                                            <label for="inputComerTime" class="col-sm-2 control-label">来访时间:</label>

                                            <div class="col-sm-4">
                                                <input type="time" class="form-control" id="inputComerTime"
                                                       placeholder="来访时间">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control" id="inputComerAge" min="1"
                                                       max="150" placeholder="年龄">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control" id="inputComerArea" min="0"
                                                       placeholder="面积">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="inputComerAreaDemand"
                                                   class="col-sm-2 control-label">需求面积:</label>

                                            <div class="col-sm-4">
                                                <input type="number" class="form-control" id="inputComerAreaDemand"
                                                       min="0" placeholder="需求面积">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputComerParkingDemand"
                                                   class="col-sm-2 control-label">车位面积:</label>

                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputComerParkingDemand"
                                                       placeholder="车位需求">
                                            </div>
                                            <label for="inputComerRoomNumDemand"
                                                   class="col-sm-2 control-label">房数需求:</label>

                                            <div class="col-sm-4">
                                                <input type="number" class="form-control" id="inputComerRoomNumDemand"
                                                       min="1" placeholder="房数需求">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputComerUnitPrice"
                                                       placeholder="单价">
                                            </div>
                                            <label for="inputComerGrossPrice"
                                                   class="col-sm-2 control-label">总价需求:</label>

                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputComerGrossPrice"
                                                       placeholder="总价需求">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputComerVocation"
                                                       placeholder="行业">
                                            </div>
                                            <label for="inputComerPurchaseMotive"
                                                   class="col-sm-2 control-label">购房动机:</label>

                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputComerPurchaseMotive"
                                                       placeholder="购房动机">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="recommendHousehold"
                                                       id="inputComerRecommendHousehold" placeholder="推荐户型">
                                            </div>
                                            <label for="inputComerRecommendHouseNo"
                                                   class="col-sm-2 control-label">推荐房号:</label>

                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="recommendHouseNo"
                                                       id="inputComerRecommendHouseNo" placeholder="推荐房号">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="salesman"
                                                       id="inputComerSalesman" placeholder="业务员">
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div id="myCall" class="tab-pane">
                            ...
                            <div class="btn-group nav">
                                <button data-target="#myCallTable" type="button" class="btn btn-item btn-default active"
                                        data-toggle="tab">来电信息列表
                                </button>
                                <button data-target="#myCallNew" type="button" class="btn btn-item btn-default"
                                        data-toggle="tab">添加来电信息
                                </button>
                            </div>
                            <div><br/></div>
                            <div class="tab-content">
                                ...
                                <div id="myCallNew" class="tab-pane col-sm-10">
                                    <form id="myCallNewForm" class="form-horizontal" action="#">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="name" id="inputCallName"
                                                       placeholder="姓名">
                                            </div>
                                            <label for="inputCallPhone" class="col-sm-2 control-label">电话号码:</label>

                                            <div class="col-sm-4">
                                                <input type="tel" class="form-control" name="phone" id="inputCallPhone"
                                                       placeholder="电话">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="propertyConsultant"
                                                       id="inputCallPropertyConsultant" placeholder="职业顾问">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="tel" class="form-control" name="owner" id="inputCallOwner"
                                                       placeholder="归属">
                                            </div>
                ...
                <div class="tab-pane sale_monitor">
                    <div class="tab-content">
                        <div id="myHousing" class="tab-pane active">
                            <ol class="breadcrumb">
                                <li><a href="#">售房管理</a></li>
                                <li class="active"><a href="#">房源管理</a></li>
                            </ol>
                            <div class="btn-group nav">
                                <button data-target="#myHousingTable" type="button"
                                        class="btn btn-item btn-default active" data-toggle="tab">房源列表
                                </button>
                                <button data-target="#myHousingNew" type="button" class="btn btn-item btn-default"
                                        data-toggle="tab">添加房源
                                </button>
                            </div>
                            <div><br/></div>
                            <div class="tab-content">
                                <div id="myHousingTable" class="tab-pane table-responsive active">
                                    <div class="pull-right">
                                        <form class="form-inline">
                                            <div class="form-group">
                                    ...
                                    <nav class="pull-right">
                                        <ul class="pagination" id="housingPagination"></ul>
                                    </nav>
                                </div>
                        ...
                        <div id="mySaleOrder" class="tab-pane">
                            <ol class="breadcrumb">
                                <li><a href="#">售房管理</a></li>
                                <li class="active"><a href="#">购房订单</a></li>
                            </ol>
                            <div class="btn-group nav">
                                <button data-target="#mySaleOrderTable" type="button"
                                        class="btn btn-item btn-default active" data-toggle="tab">购房订单列表
                                </button>
                                <button data-target="#mySaleOrderNew" type="button" class="btn btn-item btn-default"
                                        data-toggle="tab">添加购房订单
                                </button>
                            </div>
                            <div><br/></div>
                            <div class="tab-content">
                        ...
                        <div id="mySaleContract" class="tab-pane">
                            ...
                            <div class="btn-group nav">
                                <button data-target="#mySaleContractTable" type="button"
                                        class="btn btn-item btn-default active" data-toggle="tab">购房合同列表
                                </button>
                                <button data-target="#mySaleContractNew" type="button" class="btn btn-item btn-default"
                                        data-toggle="tab">添加购房合同
                                </button>
                            </div>
                            <div><br/></div>
                            <div class="tab-content">
                                <div id="mySaleContractTable" class="tab-pane table-responsive active">
                                    <div class="pull-right">
                                        <form class="form-inline">
                                            <div class="form-group">
                                                <label class="sr-only" for="signContractDate">签约时间</label>
                                                <input type="email" class="form-control" id="signContractDate"
                                                       placeholder="来访日期">
                                            </div>
                                            <div class="form-group">
                                                <label class="sr-only" for="ContractName">顾客姓名</label>
                                                <input type="password" class="form-control" id="ContractName"
                                                       placeholder="顾客姓名">
                                            </div>
                                            <button type="submit" class="btn btn-default">查询</button>
                                        </form>
                        ...
                        <div id="myCallStatistics" class="tab-pane">
                            ...
                            <div class="table-responsive">
                                <div class="pull-right">
                                    <form class="form-inline">
                                        <div class="form-group">
                                            <label class="sr-only" for="ssCallDateFrom">来电查询开始日期</label>
                                            <input type="date" class="form-control" id="ssCallDateFrom"
                                                   placeholder="来电查询开始日期">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="ssCallDateTo">来电查询结束日期</label>
                                            <input type="date" class="form-control" id="ssCallDateTo"
                                                   placeholder="来电查询结束日期">
                                        </div>
                                        <button type="submit" class="btn btn-default">查询</button>
                                    </form>
                                </div>
                            ...
                            <div class="table-responsive">
                                <div class="pull-right">
                                    <form class="form-inline">
                                        ...
                                        <div class="form-group">
                                            <label class="sr-only" for="sContactDateTo">合同查询结束日期</label>
                                            <input type="date" class="form-control" id="sContactDateTo"
                                                   placeholder="合同查询结束日期">
                                        </div>
                                        <button type="submit" class="btn btn-default">查询</button>
                                    </form>
                                </div>
                ...
                <div class="tab-pane sys_manage">
                    <div class="tab-content">
                        <div id="myDepartmentManage" class="tab-pane active">
                            ...
                            <div class="btn-group nav">
                                <button data-target="#myDepartmentTable" type="button"
                                        class="btn btn-item btn-default active" data-toggle="tab">部门及分子公司列表
                                </button>
                                <button data-target="#myDepartmentNew" type="button" class="btn btn-item btn-default"
                                        data-toggle="tab">添加部门及分子公司
                                </button>
                            </div>
                            <div><br/></div>
                            <div class="tab-content">
                                ...
                                <div id="myDepartmentNew" class="tab-pane col-sm-10">
                                    <form id="myDepartmentNewForm" class="form-horizontal" action="#">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" id="inputDepartmentName" name="department"
                                                       placeholder="部门或分子公司名称">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="inputDepartmentSubNum"
                                                   class="col-sm-2 control-label">最大子机构数:</label>

                                            <div class="col-sm-4">
                                                <input type="number" class="form-control" id="inputDepartmentSubNum"
                                                       name="subNum" min="1">
                                            </div>
                                            <label for="inputDepartmentManager"
                                                   class="col-sm-2 control-label">负责人:</label>

                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="inputDepartmentManager"
                                                       name="manager">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputDepartmentPhone"
                                                   class="col-sm-2 control-label">联系电话:</label>

                                            <div class="col-sm-4">
                                                <input type="number" class="form-control" id="inputDepartmentPhone"
                                                       name="phone">
                                            </div>
                        ...
                        <div id="myStaffManage" class="tab-pane">
                            ...
                            <div class="btn-group nav">
                                <button data-target="#myStaffTable" type="button"
                                        class="btn btn-item btn-default active" data-toggle="tab">员工列表
                                </button>
                                <button data-target="#myStaffNew" type="button" class="btn btn-item btn-default"
                                        data-toggle="tab">添加员工
                                </button>
                            </div>
                            <div><br/></div>
                            <div class="tab-content">
                                ...
                                <div id="myStaffNew" class="tab-pane col-sm-10">
                                    <form id="myStaffNewForm" class="form-horizontal" method="get" action="./reg">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" id="inputStaffNo" name="staffNo"
                                                       placeholder="工号">
                                            </div>
                                            <label for="inputStaffName" class="col-sm-2 control-label">姓名:</label>

                                            <div class="col-sm-4">
                                                <input class="form-control" id="inputStaffName" name="name"
                                                       placeholder="姓名">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="password" class="form-control" id="inputStaffPassword"
                                                       name="password" placeholder="6位以上密码">
                                            </div>
                                            <label for="inputStaffRepeatPassword"
                                                   class="col-sm-2 control-label">确认密码:</label>

                                            <div class="col-sm-4">
                                                <input type="password" class="form-control"
                                                       id="inputStaffRepeatPassword" name="repeatpassword"
                                                       placeholder="密码">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" id="inputStaffPhone" name="phone"
                                                       placeholder="电话">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" id="inputStaffEmail" name="email"
                                                       placeholder="邮箱">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" id="inputStaffAddr" name="addr"
                                                       placeholder="住址">
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div id="myRoleManage" class="tab-pane">
                            ...
                            <div class="btn-group nav">
                                <button data-target="#myRoleTable" type="button" class="btn btn-item btn-default active"
                                        data-toggle="tab">角色列表
                                </button>
                                <button data-target="#myRoleNew" type="button" class="btn btn-item btn-default"
                                        data-toggle="tab">添加角色
                                </button>
                            </div>
                            <div><br/></div>
                            <div class="tab-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="rolename"
                                                       id="inputRoleName" placeholder="名称">
                                            </div>
                                        </div>
                                        <div class="form-group">
